def string_line_to_list(string_line, separator_character):
    ...
    index_C = string_line.index(separator_character, (index_B + 1))
    new_list.append(string_line[2:index_A])
    new_list.append(string_line[index_A+1:index_B])
    new_list.append(string_line[index_B+2:index_C-1])
    new_list.append(string_line[index_C+2:(len(string_line)-3)])
    return new_list
